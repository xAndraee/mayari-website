...
const config = {
  ...
  adminTeamPage: {
    leaders: [
      ...
      { inGameName: "Arcain7", rank: "Manager",skinUrlOrPathToFile: "images/staffs/arcain7.png", rankColor: "#eff546" },
      { inGameName: "Andrae_",   rank: "Developer", skinUrlOrPathToFile: "", rankColor: "#A230CF" },
      { inGameName: "_Rizk", rank: "Manager", rankColor: "#eff546" } ],
    admins: [
      ...
      { inGameName: "Mizzu", rank: "Admin", skinUrlOrPathToFile: "images/staffs/mizzuu.png", rankColor: "" },
      { inGameName: "Nathxieee",  rank: "Admin", skinUrlOrPathToFile: "", rankColor: "" }, ],
    moderators: [
      { inGameName: "bastapasta", rank: "Moderator", skinUrlOrPathToFile: "", rankColor: "" },
      { inGameName: "RyuuBloo11", rank: "Moderator", skinUrlOrPathToFile: "", rankColor: "" } ],
    helpers: [
